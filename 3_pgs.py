...
weights = read_weights('data/PGS000297.txt')
...
workdir = '/data/project/deleted_every_sunday/hipsnphandson/workdir_height'
...
riskscores.to_csv(
    '/data/project/deleted_every_sunday/hipsnphandson/test-height.csv',
    sep=';')